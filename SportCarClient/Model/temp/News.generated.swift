...
extension News {
    ...
    @NSManaged var likedBy: Set<User>
...
extension News {
    ...
    @NSManaged private func addLikedByObject(object: User)
    @NSManaged private func removeLikedByObject(object: User)
    @NSManaged func addLikedBy(likedBy: Set<User>)
    @NSManaged func removeLikedBy(likedBy: Set<User>)
    ...
    func addLikedBy(likedBy: User) { self.addLikedByObject(likedBy) }
    func removeLikedBy(likedBy: User) { self.removeLikedByObject(likedBy) }
...
extension News {
    ...
    static let likedBy = AlecrimCoreData.Attribute<Set<User>>("likedBy")
...
extension AlecrimCoreData.AttributeType where Self.ValueType: News {
    ...
    var likedBy: AlecrimCoreData.Attribute<Set<User>> { return AlecrimCoreData.Attribute<Set<User>>("likedBy", self) }
