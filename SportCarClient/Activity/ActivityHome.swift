...
class ActivityHomeController: TaggedContainer {
    
    var mine: ActivityHomeMineListController? = ActivityHomeMineListController()
    ...
    override func createArrangedController() -> [UIViewController] {
        return [ActivityNearByListController(), mine!, ActivityAppliedController()]
    }
    
    override func titleForController(at index: Int) -> String {
        return [LS("活动"), LS("已发布"), LS("已报名")][index]
    }
...
//
//
//class ActivityHomeController2: UIViewController {
//    
