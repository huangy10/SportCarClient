...
extension Queryable {
    ...
    public func sort(using attributeName: String, ascending: Bool = true, options: NSComparisonPredicate.Options = DataContextOptions.defaultComparisonPredicateOptions) -> Self {
